  ...
  return (
    <div className="bg-orange-50 text-black ">
      ...
      <div className="text-center h-screen flex flex-col justify-center items-center">
        ...
        <p className="text-gray-500 w-3/4 md:w-1/2">
          ...
          consequuntur dolores impedit aliquid voluptatem assumenda ipsa magnam
          minima molestias eos, officia nesciunt eligendi rerum
        </p>
        <br />
        <p className="text-gray-500 w-3/4 md:w-1/2">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati
          hic ipsum harum ipsa, reprehenderit distinctio dolor beatae modi enim
          aut blanditiis saepe pariatur, aspernatur eum! Itaque aspernatur
          necessitatibus, perspiciatis similique rem, optio veritatis libero
          fugiat placeat deserunt nobis, adipisci quibusdam!
        </p>
        <div className="bg-orange-500 p-5 rounded-full aspect-square text-white font-bold mt-10 border-dotted border-4 ">
          <h1>BEST</h1>
          <h1>HOSTEL</h1>
          <h1>2020</h1>
        </div>
